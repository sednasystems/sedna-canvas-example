...
There is a scan-card example app too (example-app-scan-card.ts). To deploy this app, uncomment the line "return exampleScanCardApp"
and comment out the line "return exampleApp" in the server.ts file.
